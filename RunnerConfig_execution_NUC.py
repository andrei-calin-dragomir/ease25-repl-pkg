...
class RunnerConfig:
    ...
    name:                       str             = f"complete_experiment"
    ...
    def create_run_table_model(self) -> RunTableModel:
        ...
        factor1 = FactorModel("subject", ['numba', 'cpython', 'cython', 'pypy', 'codon', 'mypyc', 'nuitka', 'py3.13-jit', 'pyston-lite']) # 'jython', 'pyjion'
    ...
    def start_run(self, context: RunnerContext) -> None:
        ...
        env_var = 'DISABLE_PYSTON=1' if subject != 'pyston-lite' else ''

        energibrige_command = f'{env_var} sudo -S {self.project_directory}/EnergiBridge/target/release/energibridge --interval {self.metric_capturing_interval} --summary --output {self.external_run_dir}/energibridge.csv --command-output {self.external_run_dir}/output.txt taskset -c 0'
